...
(function($){
    ...
    $.fn.bxSlider = function(options){      
        ...
        var defaults = {
            ...
            responsive: false,                                                // true, false - automatic define displaySlideQty                
            
            minSlides: 1,                                                // number - minimun displaySlideQty
            maxSlides: 50,                                                // number - maximun displaySlideQty
         ...
         */
        this.reloadSlider = function(new_options){
        ...
        /**
         * Returns maximum amount of display that fits on the slide
         */
        this.calculateDisplayQty = function(){
            return Math.floor($outerWrapper.parent().width() / childrenWidth);
        }

        /**
         * Update maximum amount of display that fits on the slide
         */
        this.autoUpdateDisplayQty = function(){
            var qty = base.calculateDisplayQty();
        ...
        this.initShow = function(){
            ...
            if(options.randomStart){
                ...
                currentSlide = lastQty = randomNumber;
            ...
            if(options.responsive){
                options.displaySlideQty = base.calculateDisplayQty() || 1;
                $(window).bind('resize', resizeWindow);
            }
            
            if(options.displaySlideQty < minSlides)
                options.displaySlideQty = minSlides;
                    
            if(options.displaySlideQty > maxSlides)
                options.displaySlideQty = maxSlides;
        ...
        this.destroyShow = function(){          
            ...
            if(options.responsive) $(window).unbind('resize', resizeWindow);
        }
